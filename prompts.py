...
model = SentenceTransformer("E:/finetuned_models/dpr_allminilm")

# Example query
query = "What is the architecture proposed in the model?"
query_emb = model.encode(query, convert_to_tensor=True)

# Candidate passages
passages = [
    "In Section 3, we propose a hybrid architecture...",
    "Our model is based on BERT...",
    "This work focuses on sparse retrieval..."
]
passage_embs = model.encode(passages, convert_to_tensor=True)

# Semantic search
hits = util.semantic_search(query_emb, passage_embs, top_k=3)
print("Top result:", passages[hits[0][0]['corpus_id']])
